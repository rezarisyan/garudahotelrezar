            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img src="/hotelrezar/user/admin/profiladmin/<?php echo $_SESSION['foto1']; ?>" class="rounded-circle" alt="" style="width: 50px; height: 50px;"> 
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="/hotelrezar/logoutadmin.php" class="nav-item nav-link"><i class="fa fa-chart-bar me-2"></i>LogOut</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img src="/hotelrezar/user/admin/profiladmin/<?php echo $_SESSION['foto1']; ?>" class="rounded-circle me-lg-2" alt="" style="width: 40px; height: 40px;">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                            ...
                            <a href="/hotelrezar/logoutadmin.php" class="dropdown-item">Log Out</a>
                        </div>
                    </div>
                </div>
            </nav>
